...
parser = argparse.ArgumentParser(description="Evaluation script for electron momentum regression")
parser.add_argument("run_dir", type=str, help="Path to electron energy regression run directory")
