...
parser = argparse.ArgumentParser(description="Evaluation script for electron FC classification")
parser.add_argument("run_dir", type=str, help="Path to classification run directory")
parser.add_argument("efficiency", type=float, nargs="?", default=0.1, help="Desired electron FC efficiency for profile plots")
...
test_e_towall = test_event_towall
