...
# Electron events
position_regression_output_e = reg.WatChMaLPositionRegression(regression_run_dir, "Electron Regression", test_event_positions, test_event_directions, test_idxs,)
